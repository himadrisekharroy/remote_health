        ...
        $.post( api_url+"get_doctor_details.php", { func:"language_known"})
	     .done(function(data){
			...
			.done(function(data){
				...
				var selected_service_ids = data.data.selected_service_ids
				for(var key in selected_service_ids)
	        	{
	        		var selected_service_id = selected_service_ids[key];
	        		$('input[name="service_ids[]"][value="' + selected_service_id + '"]').attr('checked', true);		
	        	}
			})
		})
    })
